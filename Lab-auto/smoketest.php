...
<div class="container-fluid pt-4 px-4 text-dark">
                <div class="row vh-100 bg-light rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-12 text-center">
                        <h3 class="mt-20">All products</h3>
                        <table class= "table">
                            <thead>
                                <tr>
                                    <th>NAME</th>
                            ...
                            <tbody>
                                <?php
                                $query= $pdo->query("SELECT * FROM products WHERE status = 'Moved to smoke test';");
                                ...
                                foreach($allproducts as $singleproducts){
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-primary" href="smokeform.php?id=<?php echo $singleproducts['id']?>">start Smoke Test</a></td>
