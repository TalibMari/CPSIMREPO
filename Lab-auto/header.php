...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="viewport" content="width=dcateevice-width, initial-scale=1, maximum-scale=1" />
    ...
    <style>
        ...
        .footer {
            ...
            padding: 10px;
            border-top: 1px solid #dee2e6; /* Add a border if needed */
        }
    </style>
</head>
                                        ...
                                        <div class="search-content">
                                            <form method="post" action="search.php">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="productName" class="form-control autocomplete"
                                    ...
                                    <div class="dropdown-menu animated fadeIn" aria-labelledby="navbarDropdown">
                                        <div class="bg-gradient px-4 py-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="mr-1">
                                                    <h4 class="text-white mb-0">Logout</h4>
                                                    <!-- <small class="text-white">Henry@example.com</small> -->
                                                </div>
                                                <a href="index.php" class="text-white font-20 tooltip-wrapper"
                                        ...
                                        <!--<div class="p-4">
                                            ...
                                            <div class="row mt-2">
                                                ...
                                                <div class="col">
                                                    <a class="bght p-3 text-center d-block" href="#">
                                                        <i class="fe fe-plus font-20 text-primary"></i>-lig
                        ...
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                ...
                                <ul aria-expanded="false">
                                    <li class="active"> <a href='addcat.php'>Add category</a> </li>
                            ...
                            <li class="">
                                ...
                                <ul aria-expanded="false">
                                    <li class="active"> <a href='addpro.php'>Add products</a> </li>
                            ...
                            <li class="">
                                ...
                                <ul aria-expanded="false">
                                    <li class="active"> <a href='adminallpro.php'>All products</a> </li>
                                    <li> <a href='adminrej.php'>Rejected</a> </li>
                                    <li> <a href='adminapprove.php'>Approved</a> </li>
                                </ul>
                            </li>
                                           </ul>
                    </div>
